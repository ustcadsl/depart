...
public class Compaction
{
    ...
    public VersionEdit getEdit(String groupID)
    {
        return editMap.get(groupID);
    }
    ...
    public void addInputDeletions(VersionEdit edit)
    {
        ...
        System.out.println("addInputDeletions:"+edit.getDeletedFiles());
        /*for (FileMetaData input : levelUpInputs) {
            edit.deleteFile(level + 1, input.getNumber());
        }*/
    }
    
    /*public void addQueueDeletions(ArrayBlockingQueue<Long> splitedLogQueue)
    {
        for (FileMetaData input : levelInputs) {
            //edit.deleteFile(level, input.getNumber());
        	splitedLogQueue.add(input.getNumber());
        }
    }*/
