...
public class VersionEdit
{
    ...
    /*public void addFile(String groupID, int level, long fileNumber,
            long fileSize,
            InternalKey smallest,
            InternalKey largest)
    {
        FileMetaData fileMetaData = new FileMetaData(groupID, fileNumber, fileSize, smallest, largest);
    ...
    public Slice encode()
    {
        ...
        for (VersionEditTag versionEditTag : VersionEditTag.values()) {
            if(versionEditTag!=null) versionEditTag.writeValue(dynamicSliceOutput, this);//////
        }
