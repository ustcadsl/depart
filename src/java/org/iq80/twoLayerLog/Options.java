...
public class Options
{
    ...
    private int writeBufferSize = 2 << 20;

    private int maxOpenFiles = 1000;

    private int blockRestartInterval = 16; //4;
    private int blockSize = 4 * 1024;
    private CompressionType compressionType = CompressionType.NONE; //CompressionType.SNAPPY;NONE
