        ...
        implements InternalIterator
{
    ...
    public Level0Iterator(TableCache tableCache, List<FileMetaData> files, Comparator<InternalKey> comparator)
    {
        ...
        //StorageService.instance.printInfo("Level0Iterator, files size:"+files.size());
        this.inputs = builder.build();
        this.comparator = comparator;
        StorageService.instance.printInfo("Level0Iterator, inputs size:"+inputs.size());
            ...
            implements Iterator<Entry<InternalKey, Slice>>, Comparable<ComparableIterator>
    {
        ...
        {
            //StorageService.instance.printInfo("-in level0iter, this.nextElement.getKey:"+this.nextElement.getKey()+", that.nextElement.getKey:"+that.nextElement.getKey());
