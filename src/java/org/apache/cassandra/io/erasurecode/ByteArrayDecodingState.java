...
public class ByteArrayDecodingState
{
    ...
    ByteArrayDecodingState(ErasureDecoder decoder, byte[][] inputs,
    ...
    ByteArrayDecodingState(ErasureDecoder decoder,
                           int decodeLength,
                           int[] erasedIndexes,
                           byte[][] inputs,
                           int[] inputOffsets,
    ...
    ByteBufferDecodingState convertToByteBufferState() {
        ...
        ByteBufferDecodingState bbdState = new ByteBufferDecodingState(
        decoder, decodeLength, erasedIndexes, newInputs, newOutputs);
